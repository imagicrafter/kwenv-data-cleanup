...
const minimalStyles = \`*{margin:0;padding:0;box-sizing:border-box}body{min-height:100vh;display:flex;align-items:center;justify-content:center;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#f9fafb}form{display:flex;gap:8px}input[type=password]{padding:10px 16px;border:1px solid #d1d5db;border-radius:8px;font-size:14px;width:240px;outline:none}input[type=password]:focus{border-color:#6b7280}input[type=submit]{padding:10px 20px;border:none;border-radius:8px;background:#374151;color:#fff;font-size:14px;font-weight:500;cursor:pointer}input[type=submit]:hover{background:#1f2937}header,#msg,#load{display:none}\`;
